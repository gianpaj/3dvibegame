...
1. Add a live demo browser smoke that runs the fake AI worker over HTTP through `VITE_AI_WORKER_URL`.
2. Add an optional Gemini live smoke gated by `GOOGLE_GENERATIVE_AI_API_KEY`.
